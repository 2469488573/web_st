...
fakeElement.create = function(count) {
	...
	if (count == '1') {
		return '<div data-category="' + category + '" class="' + category + ' element row"><div class="span1-2 filter_img"><img src="img/portfolio/'+ image +'.jpg" alt="" width="385" height="255"><div class="portfolio_wrapper"></div><a href="img/portfolio/large/'+ image +'.jpg" class="ico prettyPhoto">l</a></div><div class="span1-2 portfolio_dscr"><h3>'+ title +'</h3><p>'+ text1 +' <a href="portfolio_post.html">Read more...</a></p></div></div>';
	} else {
		return '<div data-category="' + category + '" class="' + category + ' element row"><div class="filter_img"><img src="img/portfolio/'+ image +'.jpg" alt=""><div class="portfolio_wrapper"></div><div class="portfolio_content"><h5>'+ title +'</h5><p>'+ text1 +'</p><span class="ico_block"><a href="img/portfolio/large/'+ image +'.jpg" class="ico prettyPhoto">l</a></span>|<span class="more_block"><a href="portfolio_post.html">Read more</a></div></div></div>';
	}	
};
